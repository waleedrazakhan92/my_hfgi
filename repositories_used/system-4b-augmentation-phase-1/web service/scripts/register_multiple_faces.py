...
from utils.face_recognition_utils import register_multiple_persons
import dlib
import numpy as np
import sys
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("--savename_encodings_updated", help="name to save encoding vectors as npy array", default='encodings_data/face_encodings_updated.npy')
    parser.add_argument("--savename_encodings_paths_updated", help="name to save encoding paths as npy array", default='encodings_data/face_imgs_paths_updated.npy')
